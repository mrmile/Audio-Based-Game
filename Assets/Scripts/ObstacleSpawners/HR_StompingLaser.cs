...
public class HR_StompingLaser : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        obstacleWarning.transform.position = new Vector3(-18.5f, Ypos, 0);
        obstacle.transform.position = new Vector3(-18.5f, Ypos, 0);
